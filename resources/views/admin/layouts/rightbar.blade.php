<div class="rightbar">
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item">
                            <div class="languagebar">
                                <div class="dropdown">
                                    <a class="dropdown-toggle" href="#" role="button" id="languagelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag flag-icon-am flag-icon-squared"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="languagelink">
                                        <a class="dropdown-item" href="#"><i class="flag flag-icon-am flag-icon-squared"></i>Հայերեն</a>                                          
                                        {{-- <a class="dropdown-item" href="#"><i class="flag flag-icon-am flag-icon-squared"></i>English</a>                                           --}}
                                    </div>
                                </div>
                            </div>                                   
                        </li>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                        ...
                                        <div class="userbox">
                                            <ul class="list-unstyled mb-0">
                                                <li class="media dropdown-item">
                                                    <a href="#" class="profile-icon"><img src="/assets/images/svg-icon/user.svg" class="img-fluid" alt="user">Իմ էջը</a>
                                                </li>
                                                {{-- <li class="media dropdown-item">
                                                    <a href="#" class="profile-icon"><img src="/assets/images/svg-icon/email.svg" class="img-fluid" alt="email">Email</a>
                                                </li>                                                         --}}
                                                <li class="media dropdown-item">
                                                    <a href="#" class="profile-icon"><img src="/assets/images/svg-icon/logout.svg" class="img-fluid" alt="logout">Դուրս գալ</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/admin')}}">Գլխավոր</a></li>
    ...
    <div class="footerbar">
        <footer class="footer">
            <p class="mb-0">© 2021 ArmPanel - Բոլոր իրավունքները պաշտպանված են.</p>
        </footer>
    </div>
    <!-- End Footerbar -->
</div>